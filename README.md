...
| **Architecture** | MVVM |
| **Libraries** | Android Jetpack (Navigation Component, View Binding, RecyclerView) |
...
<div style="display: flex; gap: 10px; flex-wrap: wrap;">
  <img src="https://github.com/user-attachments/assets/cc82c2ad-e282-453b-b194-3dffe72d2c61" height="300">
</div>
...
**Author:** Mariia Stepanova, National Aviation University (Kyiv, 2024)
